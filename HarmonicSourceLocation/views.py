...
from .MultiHarSouLocation.hslocation import *
...
class MultiHarSouLocation(View):
    def get(self,request,*args,**kwargs):
        ...
        return render_to_response('MultiHarSouLocation.html', context={'DATA_BASE':DATA_BASE,'HIGH_DATA_BASE':HIGH_DATA_BASE,'LOW_DATA_BASE':LOW_DATA_BASE,'SAFE_DATA_BASE':SAFE_DATA_BASE})
