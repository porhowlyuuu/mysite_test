...
MultiHarSouLocation={"name":"多点谐波源定位","url":"/MultiHarSouLocation"};
...
INFO={'messages':INFO_CONF,'theme':'谐波源定位与责任划分',
             'top':'功能栏',"dataBases":MyDATABASES,"connect2SQL_url":CONNECT2SQL["url"],
